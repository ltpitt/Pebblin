package com.ltpitt.pebblin.crashreport
...
import com.ltpitt.pebblin.logging.FileLoggingControllerImpl
                  ...
                  ErrorReport(
                     ...
                     openGithubIssue = {
                        val searchIntent = Intent().apply {
                           ...
                           data = "https://github.com/ltpitt/Pebblin/issues/new".toUri()
                        }
