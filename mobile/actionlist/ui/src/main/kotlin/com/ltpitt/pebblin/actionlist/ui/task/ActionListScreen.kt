...
import com.ltpitt.pebblin.actionlist.ui.R
import com.ltpitt.pebblin.actionlist.ui.directorypicker.DirectoryPickerKey
import com.ltpitt.pebblin.actionlist.ui.errors.taskListUserFriendlyMessage
import com.ltpitt.pebblin.actionlist.ui.util.MaxStringSizeBytesInputTransformation
import com.ltpitt.pebblin.navigation.keys.ActionListKey
import com.ltpitt.pebblin.ui.components.AlertDialogWithContent
...
import com.ltpitt.pebblin.ui.lists.ReorderableListContainer
...
class ActionListScreen(
   ...
   override fun Content(key: ActionListKey) {
      ...
      var editDialog by remember { mutableStateOf<PebblinAction?>(null) }
...
private fun TaskListScreenContent(
   ...
   editAction: (PebblinAction) -> Unit,
   toggleActionEnabled: (PebblinAction, enabled: Boolean) -> Unit,
...
internal fun TaskListScreenContentPreview() {
   PreviewTheme {
      TaskListScreenContent(
         ActionListState(
            PebblinDirectory(1, "Test Directory"),
            listOf(
