...
import com.ltpitt.pebblin.di.ApplicationGraph
import com.ltpitt.pebblin.di.MainApplicationGraph
import com.ltpitt.pebblin.logging.ErrorReportingKermitWriter
import com.ltpitt.pebblin.logging.TinyLogKermitWriter
import com.ltpitt.pebblin.logging.TinyLogLogcatLogger
import com.ltpitt.pebblin.notifications.NotificationChannelManager
...
open class PebblinApplication : Application(), NavigationInjectingApplication {
   ...
   private fun enableStrictMode() {
      ...
      StrictMode.setVmPolicy(
         VmPolicy.Builder()
            ...
            .penaltyListener(ContextCompat.getMainExecutor(this@PebblinApplication)) { e ->
