...
import com.ltpitt.pebblin.navigation.scenes.rememberTabListDetailSceneStrategy
import com.ltpitt.pebblin.ui.theme.PebblinTheme
...
class MainActivity : ComponentActivity() {
   ...
   override fun onCreate(savedInstanceState: Bundle?) {
      val appGraph = (requireNotNull(application) as PebblinApplication).applicationGraph
