...
import com.ltpitt.pebblin.navigation.keys.OnboardingKey
   ...
   override fun Content(key: ToolsScreenKey) {
      ...
      Surface {
         ToolsScreenContent(
            ...
            openNotificationTest = { navigator.navigateTo(NotificationTestScreenKey) },
...
private fun ToolsScreenContent(
   ...
   LazyVerticalGrid(
      ...
      item {
         ToolButton(onClick = openNotificationTest, icon = R.drawable.logs, text = R.string.notification_test)
      }
